...
class Request {
  ...
  /**
   * Set encoding to response data.
   *
   * @param {String|Buffer} value - Code for encoding the response data or null. If value is null,
   * the body is returned as a Buffer otherwise the response data is encoding with the code from value.
   */
  encoding(value) {
